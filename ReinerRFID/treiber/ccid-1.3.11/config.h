...
/* Define to 1 if you have the declaration of `TAG_IFD_POLLING_THREAD', and to
   0 if you don't. */
#define HAVE_DECL_TAG_IFD_POLLING_THREAD 1
...
/* Define if usb_detach_kernel_driver_np() is available */
...
/* use libusb usb_interrupt_read() instead of polling */
/* #undef USE_USB_INTERRUPT */
